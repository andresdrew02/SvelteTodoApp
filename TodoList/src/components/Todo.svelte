<script>
    export let tarea
    export let t_important = false
    export let fn_remove
    export let completado = false
    export let fn_completada
    import danger from '../img/danger.svg'
    
</script>

<!-- svelte-ignore a11y-click-events-have-key-events -->
<div class='tarea' on:click={fn_completada}>
    {#if t_important === true}
    <img src={danger} alt="tarea importante">
    {/if}
    
    <h1 class={completado ? 'completada' : 'sinCompletar'}>
        {tarea}
    </h1>
    
    <button on:click={fn_remove}>
        <svg width="24px" height="24px" version="1.1" id="_x36_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
